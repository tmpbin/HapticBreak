...
extension L10n {
    ...
    static let strings: [String: [String]] = [
        ...
        "popover.firstIntro":      ["到点后我会一直轻轻提醒，直到你确认或真的离开。",
                                    "When it's time, I'll keep nudging gently until you acknowledge — or actually step away.",
                                    "時間になったら、確認するか席を立つまでそっと知らせ続けます。"],
        ...
        "settings.cycleFooter":    ["到点后温柔地重复提醒，直到你确认或真的离开；一直没确认就先自动推迟。休息时长大于 0 时，确认后进入休息倒计时。",
                                    "When time's up, it keeps nudging gently until you acknowledge — or actually step away. Left unacknowledged, it quietly postpones. With a rest length above 0, acknowledging starts a timed rest.",
                                    "時間になると、確認するか実際に席を離れるまでやさしく繰り返し知らせます。確認がなければそっと延期します。休憩時間が 0 より大きい場合、確認後に休憩のカウントダウンが始まります。"],
        ...
        "settings.pulseInterval":  ["未确认时每 %d 秒再轻提醒", "Re-nudge every %d s until acknowledged", "確認まで %d 秒ごとに再通知"],
